  ...
  return (
    <section className="relative">
      ...
      <div className="flex flex-col items-center text-center space-y-4">
        ...
        <h3>Watch how Aterera transforms <span className="bg-linear-to-r from-rose-500 to-rose-700 bg-clip-text text-transparent">this Next.js course.PDF</span> into an easy-to-read summary</h3>
      </div>
    </section>
  );
}